...
import { View, Text, TextInput, ActivityIndicator, Image, StyleSheet, TouchableOpacity, StatusBar, Keyboard } from 'react-native';
...
const ForgotPasswordScreen = () => {
  ...
  const handleCIDSubmit = async () => {
    try {
      ...
      // const response = await fetch('http://192.168.0.119:8000/forgot-password', {
      ...
      if (response.ok) {
        ...
        console.error('Failed to send CID for password reset. Response status:', response.status);
